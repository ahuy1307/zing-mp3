	...
	return (
		<>
			...
			<div className="text-[var(--text-primary)] px-[10px] md:pl-[100px] xl:pl-[300px] md:px-[30px] xl:px-[60px]">
				<div className="mt-[100px] mb-[42px] flex items-center gap-x-2">
					<h1 className="text-[var(--text-primary)] font-bold text-2xl">Top Trending</h1>
					<button className="bg-[var(--purple-primary)] rounded-full p-[6px]">
						<BsFillPlayFill className="w-7 h-7 relative left-[2px]" color="white" />
					</button>
				</div>
				<div className="flex gap-x-6 items-center mt-6 text-[var(--text-primary)]">
					<button
						className={twMerge(
